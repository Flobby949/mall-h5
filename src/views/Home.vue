<template>
  <div class="home">
    <!-- 顶部导航 -->
    <header class="home-header wrap" :class="{ active: headerScroll }" :style="{ background: opacity }">
      <!-- 点击搜索框跳转到分类页 -->
...
export default {
  ...
  methods: {
    pageScroll() {
      ...
      scrollTop > 40 ? (this.headerScroll = true) : (this.headerScroll = false)
      this.opacity = `rgb(194, 0, 0, ${scrollTop / 40})`
    },
  },
}
</script>
