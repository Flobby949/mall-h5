<template>
  <div class="address-edit-box">
    <s-header :title="`${type == 'add' ? '新增地址' : '编辑地址'}`">
...
import { addAddress, editAddress, delAddress, getAddressDetail } from '../service/address'
...
export default {
  ...
  methods: {
    ...
    async onDelete() {
      //调用删除地址接口
      const res = await delAddress(this.addressId)
